...
const months: Array<CronJobsSelectOption> = [
...
const baseFrequency: Array<CronJobsSelectOption> = [
...
const hours: Array<CronJobsSelectOption> = [
...
export class DataService {
  ...
  private minutesOptions: Array<CronJobsSelectOption>;
  ...
  constructor() {
    ...
    for (let x = 0; x < 60; x = x + 5) {
      this.minutesOptions.push(<CronJobsSelectOption>{value: x, label: `${x}`});
    }
  }
